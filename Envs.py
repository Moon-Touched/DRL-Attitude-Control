...
from Basilisk.utilities import RigidBodyKinematics, unitTestSupport, macros
...
class BasiliskModel:
    def __init__(self, timestep: float, I: list, ref_MRP: list, torque_mode: str = "wheel") -> None:
        ...
        self.cur_error_MRP = RigidBodyKinematics.subMRP(self.cur_MRP, -self.ref_MRP)
...
class BaseEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.model = BasiliskModel(0.01, [0.025, 0, 0, 0, 0.05, 0, 0, 0, 0.065], self.ref_MRP, torque_mode="wheel")
        self.reward = 0
        self.action = np.zeros(4, dtype=np.float32)  # 四轮力矩
